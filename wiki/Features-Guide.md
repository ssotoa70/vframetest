...
> **CRITICAL FIX**: v25.17.4 fixes a critical latency calculation bug from v25.17.3 and earlier. Latency values in v25.17.3 were reported as 2.6×10^15 times larger than actual. Upgrade immediately if using completion time metrics.
