	...
	while (i < 7) {
		...
		if (i >= 2) {
			...
			if (seq[0] == '[') {
				...
				if (seq[1] >= 'A' && seq[1] <= 'D') {
					switch (seq[1]) {
						case 'A': return TTY_KEY_UP;
						case 'B': return TTY_KEY_DOWN;
						case 'C': return TTY_KEY_RIGHT;
						case 'D': return TTY_KEY_LEFT;
					}
				}
				/* Home/End: ESC [ H / ESC [ F */
				if (seq[1] == 'H') return TTY_KEY_HOME;
				if (seq[1] == 'F') return TTY_KEY_END;
				
				/* Extended sequences: ESC [ N ~ */
				if (i >= 3 && seq[2] == '~') {
					switch (seq[1]) {
						case '1': return TTY_KEY_HOME;
						case '2': return TTY_KEY_INSERT;
						case '3': return TTY_KEY_DELETE;
						case '4': return TTY_KEY_END;
						case '5': return TTY_KEY_PAGEUP;
						case '6': return TTY_KEY_PAGEDOWN;
					}
				}
				
				/* Function keys: ESC [ NN ~ */
				if (i >= 4 && seq[3] == '~') {
					int num = (seq[1] - '0') * 10 + (seq[2] - '0');
					switch (num) {
						case 11: return TTY_KEY_F1;
						case 12: return TTY_KEY_F2;
						case 13: return TTY_KEY_F3;
						case 14: return TTY_KEY_F4;
						case 15: return TTY_KEY_F5;
						case 17: return TTY_KEY_F6;
						case 18: return TTY_KEY_F7;
						case 19: return TTY_KEY_F8;
						case 20: return TTY_KEY_F9;
						case 21: return TTY_KEY_F10;
						case 23: return TTY_KEY_F11;
						case 24: return TTY_KEY_F12;
					}
				}
			}
			/* SS3 sequences: ESC O ... (alternate arrow keys) */
				...
				switch (seq[1]) {
					...
					case 'C': return TTY_KEY_RIGHT;
					case 'D': return TTY_KEY_LEFT;
					case 'H': return TTY_KEY_HOME;
					case 'F': return TTY_KEY_END;
					case 'P': return TTY_KEY_F1;
					case 'Q': return TTY_KEY_F2;
					case 'R': return TTY_KEY_F3;
					case 'S': return TTY_KEY_F4;
				}
			}
		}
